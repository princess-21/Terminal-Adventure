    ...
    if (isMobile) {
      return (
        <div
          ...
          data-mobile="true"
          className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground fixed inset-y-0 left-0 z-50 transform -translate-x-full transition-transform duration-200 ease-in-out"
          style={{
        ...
        >
          ...
          <div
            className="absolute top-4 right-4 p-1 rounded-full bg-background cursor-pointer"
